...
namespace Memory
{
    ...
    public class Mem
    {
        ...
        public uint MEM_FREE = 0x10000;
        public uint MEM_COMMIT = 0x00001000;
        public uint MEM_RESERVE = 0x00002000;

        public uint PAGE_READONLY = 0x02;
        public uint PAGE_READWRITE = 0x04;
        public uint PAGE_WRITECOPY = 0x08;
        public uint PAGE_EXECUTE_READWRITE = 0x40;
        public uint PAGE_EXECUTE_WRITECOPY = 0x80;
        public uint PAGE_EXECUTE = 0x10;
        public uint PAGE_EXECUTE_READ = 0x20;

        public uint PAGE_GUARD = 0x100;
        public uint PAGE_NOACCESS = 0x01;
        ...
        public UIntPtr CreateCodeCave(string code, byte[] newBytes, int replaceCount, int size = 0x10000, string file = "")
        {
            ...
            {
                caveAddress = VirtualAllocEx(pHandle, FindFreeBlockForRegion(prefered, (uint)newBytes.Length + 4),
        ...
        public UIntPtr FindFreeBlockForRegion(UIntPtr baseAddress, uint size)
        {
